"""
Converts xls to csv for the NYC Property Sales data set
This script is used to convert xls files to csv format. It takes a directory of xls files and converts each file into a csv file. The output file is specified as a command line argument.
The script uses the xlrd library to read the xls files and the csv library to write the csv files. It also uses glob to find all xls files in the specified directory.

use: python3 xls_to_csv.py nyc-property-sales.csv
